...
sap.ui.define([
	...
	return BaseController.extend("CRUD_test.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("UserId", FilterOperator.StartsWith, sQuery)];
				/*this._oListFilterState.aSearch = [];
				this._oListFilterState.aSearch.push(new Filter({
					filters: [ new Filter("UserId", FilterOperator.Contains, sQuery),
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							UserId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("UserId"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				UserId: encodeURIComponent(oItem.getBindingContext().getProperty("UserId"))
			}, bReplace);
		},
