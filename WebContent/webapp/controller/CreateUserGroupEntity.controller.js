sap.ui.define([
	...
	return BaseController.extend("CRUD_test.controller.CreateUserGroupEntity", {
		...
		onInit: function() {
			var that = this;
			this.getRouter().getTargets().getTarget("createUserGroup").attachDisplay(null, this._onDisplay, this);
			...
			//this.byId("UserGroupId_id").bindProperty("value", "UserGroupId");
		...
		_onCreate: function(oEvent) {
			if (oEvent.getParameter("name") && oEvent.getParameter("name") !== "createUserGroup") {
			...
			var currentUserId = this._oODataModel.getProperty(oData.objectPath + "/UserId");  
			this._oViewModel.setProperty("/currentUserId", currentUserId);		

			
			//var oContext = this._oODataModel.createEntry("UserGroupSet('2020')/Asset", {
			var oContext = this._oODataModel.createEntry(oData.objectPath + "/UserGroup", {
		...
		_validateSaveEnablement: function() {
			var aInputControls = this._getFormFields(this.byId("newUserGroupEntitySimpleForm"));
			var oControl;
