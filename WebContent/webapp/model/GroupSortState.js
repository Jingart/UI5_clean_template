sap.ui.define([
	...
	return BaseObject.extend("CRUD_test.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias CRUD_test.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "UserGroupId");
			}
